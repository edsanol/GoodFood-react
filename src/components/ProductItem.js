  ...
  return (
    <div className="Products__container-product">
      <div className="Product__food-image">
        <img src={imageFood} alt="image-food" />
      </div>
      <div className="Product__detail">
        ...
        <p className="Product__food-detail">
          ...
          dolor sit amet, consectetur adipis occ lorem lorem ipsum dolor sit amet, consectetur adipis occ lorem lorem ipsum
          dolor sit amet, consectetur adipis occ lorem
        </p>
